...
**Modifier Events:**
Before inserting records, the `insert` event is triggered on any table modifiers.
See [modifiers documentation](./9.modifiers.md) for details on modifier integration.
...
**Modifier Events:**
Before updating records, the `update` event is triggered on any table modifiers.
See [modifiers documentation](./9.modifiers.md) for details on modifier integration.
